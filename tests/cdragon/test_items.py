...
from cdragon.items import ITEMS_URL, Color, Item, get_items, _parse_item_name
...
def test_get_items_ok():
    responses.add(responses.GET, ITEMS_URL, json=_dummy_items_response(), status=200)
    expected_results = [
        Item(
            guid="fe3a63e6-cc62-4299-a52a-d65755cf6cff",
            name="Blade of the Ruined King",
            id=28,
            color=Color(R=186, B=255, G=46, A=255),
